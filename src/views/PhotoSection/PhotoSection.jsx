    ...
    <div className="PhotoSection">
      ...
      <section className="selim image-section">
        ...
        <div className="image-box">
          <h3>"Ashtray"</h3>
          <ReactCompareImage leftImage={ashtray_selim} rightImage={ashtray_selim} />
        ...
        <div className="image-box">
          <h3>"Tipp-Ex"</h3>
          <ReactCompareImage leftImage={tippex_selim} rightImage={tippex_selim} />
          <div className="image-description">
            <div className="description-group">
              <h4 className="description-title">Exposure</h4>
        ...
        <div className="image-box">
          <h3>"Chair"</h3>
          <ReactCompareImage leftImage={chair_selim} rightImage={chair_selim} />
          <div className="image-description">
            <div className="description-group">
              <h4 className="description-title">Exposure</h4>
      ...
      <section className="tobias image-section">
        ...
        <div className="image-box">
          <h3>"Stone"</h3>
          <ReactCompareImage leftImage={stone_tobias} rightImage={stone_edited_tobias} />
          <div className="image-description">
            <div className="description-group">
              <h4 className="description-title">Exposure</h4>
        ...
        <div className="image-box">
          <h3>"Tipp-Ex"</h3>
          <ReactCompareImage leftImage={tippex_tobias} rightImage={tippex_edited_tobias} />
          <div className="image-description">
            <div className="description-group">
              <h4 className="description-title">Exposure</h4>
        ...
        <div className="image-box">
          <h3>"Tower"</h3>
          <ReactCompareImage leftImage={tower_tobias} rightImage={tower_edited_tobias} />
          <div className="image-description">
            <div className="description-group">
              <h4 className="description-title">Exposure</h4>
      ...
      <section className="kim image-section">
        ...
        <div className="image-box">
          <h3>"Ashtray"</h3>
          <ReactCompareImage leftImage={ashtray_kim} rightImage={ashtray_kim} />
          <div className="image-description">
            <div className="description-group">
              <h4 className="description-title">Exposure</h4>
              <h4 className="description-value">1/160 s</h4>
        ...
        <div className="image-box">
          <h3>"Bottle"</h3>
          <ReactCompareImage leftImage={bottle_kim} rightImage={bottle_kim} />
          <div className="image-description">
            <div className="description-group">
              <h4 className="description-title">Exposure</h4>
              <h4 className="description-value">1/100 s</h4>
        ...
        <div className="image-box">
          <h3>"Lock"</h3>
          <ReactCompareImage leftImage={lock_kim} rightImage={lock_kim} />
          <div className="image-description">
            <div className="description-group">
              <h4 className="description-title">Exposure</h4>
              <h4 className="description-value">1/100 s</h4>
